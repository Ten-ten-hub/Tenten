...
class InternalDeliveryControllerRestDocsTest {
    ...
    private ResponseFieldsSnippet commonDeliveryResponseFields() {
        return responseFields(
            ...
            fieldWithPath("data.startedAt").optional().description("배송 시작 시각"),
            fieldWithPath("data.completedAt").optional().description("배송 완료 시각"),
            ...
            fieldWithPath("data.updatedAt").optional().description("수정 시각"),
            ...
            fieldWithPath("data.routeLogs[].departedAt").optional().description("출발 시각"),
            fieldWithPath("data.routeLogs[].arrivedAt").optional().description("도착 시각"),
            fieldWithPath("code").type(JsonFieldType.STRING).description("응답 코드"),
            fieldWithPath("message").type(JsonFieldType.STRING).description("응답 메시지")
        );
    }
